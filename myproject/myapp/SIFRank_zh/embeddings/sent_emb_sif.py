...
class SentEmbeddings():
    ...
    def __init__(self,
                 word_embeddor,
                 weightfile_pretrain='G:/Graduation_Design/dataset/SIFRank_zh-master/SIFRank_zh-master/auxiliary_data/dict.txt',
                 weightfile_finetune='G:/Graduation_Design/dataset/SIFRank_zh-master/SIFRank_zh-master/auxiliary_data/dict.txt',
